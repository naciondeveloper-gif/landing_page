...
const faqs = [
  {
    ...
    a: 'El precio del lote con casa es de S/.139,000. El precio puede variar según la ubicación del lote dentro del conjunto residencial. Selecciona un lote en el mapa interactivo para ver disponibilidad y detalles específicos.',
  },
  {
