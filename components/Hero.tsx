...
export default function Hero() {
  return (
    <section className="relative w-full h-[80vh] flex items-center justify-center bg-slate-900 text-white overflow-hidden">
      <div className="absolute inset-0 bg-[url('/house.jpg')] bg-cover bg-center opacity-40"></div>
      <div className="relative z-10 text-center px-4">
        <h1 className="text-5xl md:text-5xl font-extrabold tracking-tight mb-6">
          Conjunto Residencial <span className="text-amber-500 text-7xl">Chavín de Huántar</span>
        </h1>
